...
function TwistClock() {
    ...
    return (
        <>
            <div className="relative w-[250px] h-[250px] flex items-center  bg-black rounded-full mx-auto mt-12 font-vt323 text-green-400">
                ...
                {/* Clock numbers */}
                <span
                    className="absolute top-2 left-1/2 -translate-x-1/2 text-xl drop-shadow-[0_0_6px_#22c55e]">6</span>
                <span
                    className="absolute bottom-2 left-1/2 -translate-x-1/2 text-xl drop-shadow-[0_0_6px_#22c55e]">12</span>
                <span
                    className="absolute top-1/2 right-2 -translate-y-1/2 text-xl drop-shadow-[0_0_6px_#22c55e]">3</span>
                <span
                    className="absolute top-1/2 left-2 -translate-y-1/2 text-xl drop-shadow-[0_0_6px_#22c55e]">9</span>
            </div>
