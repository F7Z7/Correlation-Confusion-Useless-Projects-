    ...
    return (
        <div
            ...
            <div className="w-full max-w-2xl text-center bg-white/20 backdrop-blur-lg rounded-3xl shadow-2xl p-8 ">
                ...
                <div className="flex items-center justify-around p-3 gap-3">
                    <Button text="Random" icon={Shuffle} gradient="bg-gradient-to-r from-cyan-500 to-blue-500  hover:bg-blue-300" />
                    ...
                    <Button text="Clear Selection" icon={Eraser} gradient="bg-gradient-to-r from-red-800 to-red-500 hover:from-red-500 hover:red-300"/>
                </div>
            </div>
        </div>
    );
